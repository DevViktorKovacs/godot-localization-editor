...
namespace godotlocalizationeditor
{
    public static class ExtensionMethods
    {
        ...
        public static IEnumerable<T> ToList<T>(this Array<T> array)
        {
        ...
        public static IEnumerable<T> ToList<T>(this Godot.Collections.Array array)
        {
            for (int i = 0; i < array.Count; i++)
            {
        ...
        public static int IndexOf<TKey, TValue>(this System.Collections.Generic.Dictionary<TKey, TValue> dictionary, TKey key)
        {
